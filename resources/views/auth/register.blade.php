...
<body>
    ...
    <div class="flex justify-center w-full my-20">
        <form method="POST" action="{{ route('register') }}" class="w-5/12 shadow-md px-7 py-4">
            @csrf
            <h2 class="text-3xl font-bold text-center mb-3.5">Create your Account</h2>
            <div class="grid grid-cols-2 gap-x-4 gap-y-1.5">
                <div class="flex flex-col w-full">
                    <label for="first_name" class="text-sm leading-6">First Name</label>
                    <input id="first_name" type="text" name="first_name" class="rounded-md" required autofocus autocomplete="given-name"/>
                </div>
                <div class="flex flex-col w-full">
                    <label for="last_name" class="text-sm leading-6">Last Name</label>
                    <input id="last_name" type="text" name="last_name" class="rounded-md" required autofocus autocomplete="family-name"/>
                </div>
                ...
                <div class="col-span-2 flex flex-col">
                    <label for="password_confirmation" class="text-sm leading-6">Confirm Password</label>
                    <input id="password_confirmation" type="password" class="rounded-md" name="password_confirmation" required autocomplete="new-password"/>
                    <p></p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-center mt-6">
                <button class="bg-[#00B207] text-white w-full py-2 rounded-full hover:opacity-70 transition ease-in-out duration-150">Register</button>
            </div>
            <div class="flex items-center justify-center mt-4">
                <p class="text-gray-600 text-sm mr-2">Already have an account?</p>
